...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center hero-enterprise dot-pattern overflow-hidden">
      {/* Subtle mesh layer */}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
        <div className="absolute top-[12%] start-[8%] w-72 h-72 rounded-full bg-primary/10 blur-3xl animate-float" />
        <div className="absolute top-[58%] end-[12%] w-96 h-96 rounded-full bg-accent-saas/10 blur-3xl animate-float-slow" style={{ animationDelay: "2s" }} />
