    ...
    <section className="py-28 relative overflow-hidden section-dark">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <ScrollReveal>
          ...
          <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 px-10 rounded-xl font-semibold shadow-elegant transition-all hover:-translate-y-0.5">
            <Link to="/contact">
              {t("cta.button")}
